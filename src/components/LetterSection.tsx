  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center min-h-[400px] w-full max-w-md">
      ...
      >
        ...
        {/* Letter inside */}
        <motion.div
          className="absolute bottom-2 w-[90%] bg-[#fffdf8] p-6 rounded shadow-lg text-center font-serif text-rose-900 border border-rose-100 flex flex-col justify-center items-center"
          initial={{ y: 0, height: '90%', zIndex: 10 }}
          animate={{ 
            y: isOpen ? -160 : 0, 
            height: isOpen ? '140%' : '90%',
            zIndex: isOpen ? 30 : 10 
          }}
        ...
        >
          ...
          <p className="mt-4 text-lg italic text-rose-700">
